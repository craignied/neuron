...
slot --- \texttt{setDataSet}, \texttt{setHidden}, \texttt{forward},
\texttt{innerTrainSet}, \texttt{unpack}, and \texttt{removeInputs} --- stays
where the biased and unbiased equations can be read side by side.
