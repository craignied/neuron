The retired command-line menus remain supported for compatibility, scripted
legacy operation, and regression testing, but receive no further feature work.
The REST API in Chapter \ref{rest_api} is authoritative for new interactive
capabilities; the GUI described in Chapter \ref{modern_architecture} is its
primary human client.
