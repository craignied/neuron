...
DeLong inference.  Omit it for point estimates only.
\end{description}
...
JSON artifacts.  A locked test adds per-row predictions and, when its
independence assumption is declared, paired AUC confidence intervals
and the prespecified DeLong contrast.
